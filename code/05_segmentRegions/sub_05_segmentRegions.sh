...
Rscript code/cindy/05_segmentRegions/05_segmentRegions.R processed-data/cindy/slide-${slide}/${sample}_SFE_filt.RDS processed-data/cindy/04_delaunay/${sample}_${slide}-delaunay-lou25.RDS  
